...
export function mapProperty(raw: Record<string, any>): Property {
  ...
  return {
    ...
    providerLabel: p.providerLabel || undefined,
    promotionRole: p.promotionRole || undefined,
    promotion: p.promotion || undefined,
    sourceType: p.sourceType,
    promotionAuthorized: offering?.promotion_authorized,
    informationVerifiedAt: offering?.information_verified_at || p.informationVerifiedAt || undefined,
    publicProviderLabel: offering?.public_provider_label || p.providerLabel || undefined,
    internalSourceReference: offering?.internal_source_reference || undefined,
...
export function buildPropertyPayload(item: Property, propertyTypeId: string, location?: Location) {
  ...
  return {
    ...
    offering: {
      ...
      promotion_authorized: Boolean(item.promotionAuthorized),
      information_verified_at: item.informationVerifiedAt || null,
      public_provider_label: item.publicProviderLabel || null,
      internal_source_reference: item.internalSourceReference || null,
