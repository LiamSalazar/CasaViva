...
Región `mx-central-1`; dos subredes públicas y dos privadas en dos AZ soportadas, sin NAT Gateway. Una EC2 `t4g.small` ARM64 con EBS gp3 cifrado de 30 GB ejecuta Caddy, Next, Django y PostgreSQL 18 en Docker. La instancia stateful tiene `prevent_destroy`, no ASG y no ofrece HA. Sólo 80/443 son públicos; SSM sustituye SSH.
